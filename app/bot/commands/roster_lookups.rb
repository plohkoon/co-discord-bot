module Commands
  # Shared option plumbing for /guild create and /team edit: category and team
  # type are picked from the guild's curated lists (managed on the web guild
  # page), never created on the fly. Autocomplete offers the lists; typed values
